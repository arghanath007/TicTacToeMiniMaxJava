...
public class TicTacToeAI extends Board {
    ...
    public static int[][] getPossibleMoves(Board bd) { //gets all possible moves
        ...
        int[][] possibleMoves = new int[moves.size()][2]; // Possible moves will contain 1d arrays each of two integers
    ...
    {
        //allows user to enter coordinates into the board
        try {
    ...
    public static boolean compWin(String[][] board)
    {
        ...
        for (int i = 0; i < 5; i += 2)
        {
            ...
            // checking the verticals(Columns)
        ...
        {
            // checking first or left diagonal
        ...
        {
            // checking second or right diagonal
    ...
    public static boolean tie(String[][] bd)
    {
        // checks tie between computer and user
        for (int i = 0; i < 5; i += 2) {
            for (int j = 0; j < 5; j += 2) {
                if (bd[i][j].equals("     "))
                    return false;
    ...
    public static void main(String[] args) {
        System.out.println("\nWelcome to the Tic Tac Toe game.\nEnter your move with coordinates between 1 to 9. Your input should be two integers separated by a space." +
